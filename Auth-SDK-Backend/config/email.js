...
export const createPasswordResetEmailTemplate = (otp, userEmail) => {
  return {
    from: `"${process.env.EMAIL_FROM_NAME || 'Project-Name'}" <${process.env.EMAIL_USER}>`,
    to: userEmail,
    subject: 'Password Reset Verification Code - Project-Name',
    html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
        ...
        <title>Password Reset - Project-Name</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <p>We received a request to reset your password for your  account. To complete the password reset process, please use the verification code below:</p>
          ...
          <div class="footer">
            <p>This email was sent from Project-Name - Your  Practice Management System</p>
    ...
    `,
    text: `
      Password Reset Verification - Project-Name
...
export const sendPasswordResetEmail = async (userEmail, otp) => {
  try {
    ...
    if (!process.env.EMAIL_USER || !process.env.EMAIL_APP_PASSWORD) {
      console.log('Email configuration not found. Please create .env file with email settings.');
